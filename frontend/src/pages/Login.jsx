...
import { Mail, Lock, UserCircle, LogIn, Sparkles, GraduationCap, ArrowRight, ShieldCheck, Zap } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen w-full flex bg-[#0f172a] font-sans selection:bg-indigo-500/30 overflow-hidden">
            ...
            <div className="hidden lg:flex w-1/2 relative bg-[#1e293b] p-12 flex-col justify-between overflow-hidden">
                ...
                {/* Testimonial/Feature Card Snippet */}
                <motion.div
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center ml-1">
                                ...
                                <a href="#" className="text-xs font-bold text-indigo-500 hover:text-indigo-400 transition-colors">Forgot Password?</a>
                            </div>
                            <div className="relative group">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <select
                                    ...
                                    value={formData.role}
                                >
                                    <option value="STUDENT" className="bg-slate-900 italic">I am a Student</option>
                                    <option value="INSTRUCTOR" className="bg-slate-900 italic">I am an Instructor</option>
                                </select>
                            </div>
                        </div>
