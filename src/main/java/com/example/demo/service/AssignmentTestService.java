...
public class AssignmentTestService {
        ...
        private String generateQuestions(String topic) {
                ...
                List<Map<String, Object>> topicQuestions = questionBank.getOrDefault(cleanTopic, new ArrayList<>());

                // If no questions found for topic, use math as default
                if (topicQuestions.isEmpty()) {
                        System.out.println("DEBUG_TEST: No specific questions for " + cleanTopic
                                        + ", using default Math.");
        ...
        private Map<String, List<Map<String, Object>>> getQuestionBank() {
                ...
                List<Map<String, Object>> mathQuestions = Arrays.asList(
                                ...
                                createQuestion("What is 2³ (2 to the power of 3)?", Arrays.asList("6", "8", "9", "12"),
                                                "8"),
                                createQuestion("What is the perimeter of a square with side 5cm?",
                                                Arrays.asList("15cm", "20cm", "25cm", "30cm"), "20cm"),
                                createQuestion("What is 0.5 as a fraction?", Arrays.asList("1/2", "1/3", "1/4", "1/5"),
                                                "1/2"),
                ...
                List<Map<String, Object>> scienceQuestions = Arrays.asList(
                                ...
                                createQuestion("What gas do plants absorb from the atmosphere?",
                                                ...
                                                "Carbon Dioxide"),
                                createQuestion("How many bones are in the adult human body?",
                ...
                List<Map<String, Object>> englishQuestions = Arrays.asList(
                                ...
                                createQuestion("What is the past tense of 'run'?",
                                                Arrays.asList("Runned", "Ran", "Running", "Runs"),
                                                "Ran"),
                                createQuestion("What is a synonym for 'happy'?",
                                                Arrays.asList("Sad", "Joyful", "Angry", "Tired"),
                                                "Joyful"),
                                ...
                                createQuestion("What is the plural of 'child'?",
                                                ...
                                                "Children"),
                                createQuestion("What is an antonym of 'hot'?",
                                                Arrays.asList("Warm", "Cold", "Cool", "Freezing"),
                                                "Cold"),
                                ...
                                createQuestion("What is the past tense of 'go'?",
                                                Arrays.asList("Goed", "Gone", "Went", "Going"),
                                                "Went"),
                                createQuestion("What is a pronoun?",
                                                Arrays.asList("I, you, he, she", "Run, jump, play", "Big, small, red",
                                                                "And, but, or"),
                                                "I, you, he, she"),
                                createQuestion("What is the plural of 'mouse'?",
                                                Arrays.asList("Mouses", "Mice", "Meese", "Mices"),
                                                "Mice"),
                                createQuestion("Which word is a preposition?",
                                                Arrays.asList("Run", "Happy", "Under", "Quickly"),
                                                "Under"),
