...
public class LessonController {
    ...
    public ResponseEntity<List<Lesson>> getLessonsByCourse(@PathVariable("courseId") Long courseId) {
    ...
    public ResponseEntity<Lesson> updateLesson(@PathVariable("lessonId") Long lessonId,
            @Valid @RequestBody Lesson lesson) {
